...
public class Tablo extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        mainTable.setBackground(new java.awt.Color(255, 153, 102));
        mainTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "AD", "SOYAD", "TC", "TELEFON", "YAŞ", "CİNSİYET", "KAN GRUBU", "BRANŞ", "EĞİTMEN", "SEANS", "SAAT", "SÜRE", "Acil AD", "Acil Soyad", "Acil Tel"
            }
        ) {
